%% TODO: Re-do profiling!
%% 10 times original, auto update
%% 10 times original, no auto update
%% 10 times solution, no auto update
...
\begin{table}[ht]
    ...
    \begin{tabular}{ l c }
        ...
        \textbf{EMFPatternLanguageJvmModelInferrer lambdas} & - \\
        ... & - \\
        \textbf{AbstractTypeInferrer.getJvmType} & 88\% \\
        \textbf{CompoundMetamodelProviderService.getQualifiedClassName} & 79\% \\
        \bottomrule
    \end{tabular}
...
\begin{table}[ht]
    ...
    \begin{tabular}{ l c }
        ...
        \textbf{EMFPatternLanguageJvmModelInferrer lambdas} & - \\
        ... & - \\
        \textbf{AbstractTypeInferrer.getJvmType} & 49\% \\
        \textbf{AbstractTypeInferrer.getType} & 37\% \\
        \bottomrule
    \end{tabular}
